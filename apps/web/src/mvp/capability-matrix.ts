...
export const operatorCapabilityMatrix = [
  ['GitHub Project snapshot', 'tracker_snapshots → listProjectTaskViews', 'Delivery Kanban/detail', 'fresh/stale/error'],
  ['Create project', 'projects()', 'Portfolio: Создать проект', 'success/error'],
  ...
  ['Exact approval', 'decideApproval → approval()', 'Delivery: Зафиксировать согласование', 'recorded/duplicate/conflict/denied'],
  ...
  ['Messenger delivery', 'audit_events/outbox_events/identity read projection', 'Conversations', 'ingress/pending/delivered/failure/no data']
] as const;
