...
export const bindHermesConversation = (input: Readonly<{profile: HermesProfile; source: Source; action: unknown;
  ...
  const allowed = input.profile === 'internal'
    ? ['project_facts.read', 'project_context.read', 'process.start', 'project.execution.mode', 'issue.create', 'issue.update', 'issue.clarify', 'project_item.stage', 'source.add', 'approval.decide']
