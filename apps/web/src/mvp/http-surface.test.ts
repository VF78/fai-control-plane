...
describe('MVP HTTP surface contract', () => {
  it('contains exactly the approved 14 API routes, including context refresh and agent routing', () => {
    expect(mvpApiRoutes).toHaveLength(14);
    expect(new Set(mvpApiRoutes).size).toBe(14);
