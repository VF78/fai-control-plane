...
import {Dialog} from '../ui/foundation.tsx';
...
export function ProjectDeleteControl({projectId,projectName}:Readonly<{projectId:string;projectName:string}>){
  const [confirming,setConfirming]=useState(false);const [confirmation,setConfirmation]=useState('');const command=useAsyncCommand();
