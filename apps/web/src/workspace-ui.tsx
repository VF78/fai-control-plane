...
function Access({route, project, access}: {route: WorkspaceUiRoute; project: ProjectData; access: AccessData | null}) {
...
function People({route, access}: {route: WorkspaceUiRoute; access: AccessData | null}) {
