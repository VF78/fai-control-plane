export const defaultAgentStageInstructions = (role: 'manager'|'developer'|'qa') => role === 'manager'
  ? {constraints: [
    ...
    'Use your persistent gh credential to change this same Project item to the configured next stage and verify GitHub readback.'
  ...
  ? {constraints: [
    ...
    'Use your persistent gh credential to change the same Project item to the exact configured next stage and verify GitHub readback before returning.'
  ], acceptanceCriteria: [
    ...
    'Use your persistent gh credential to change the same Project item to the configured rework or next stage and verify GitHub readback before returning.'
  ], acceptanceCriteria: [
