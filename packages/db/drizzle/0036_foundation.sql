...
ALTER TABLE "project_scope_baseline_versions" ADD CONSTRAINT "project_scope_baseline_versions_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE cascade;--> statement-breakpoint
ALTER TABLE "project_scope_baseline_versions" ADD CONSTRAINT "project_scope_baseline_versions_approved_by_actor_id_actors_id_fk" FOREIGN KEY ("approved_by_actor_id") REFERENCES "public"."actors"("id") ON DELETE set null;--> statement-breakpoint
ALTER TABLE "project_scope_baseline_versions" ADD CONSTRAINT "project_scope_baseline_versions_checkpoint_owner_actor_id_actors_id_fk" FOREIGN KEY ("checkpoint_owner_actor_id") REFERENCES "public"."actors"("id") ON DELETE set null;--> statement-breakpoint
ALTER TABLE "project_scope_outcomes" ADD CONSTRAINT "project_scope_outcomes_baseline_id_project_scope_baseline_versions_id_fk" FOREIGN KEY ("baseline_id") REFERENCES "public"."project_scope_baseline_versions"("id") ON DELETE cascade;--> statement-breakpoint
ALTER TABLE "project_scope_outcomes" ADD CONSTRAINT "project_scope_outcomes_accepted_by_actor_id_actors_id_fk" FOREIGN KEY ("accepted_by_actor_id") REFERENCES "public"."actors"("id") ON DELETE set null;--> statement-breakpoint
ALTER TABLE "project_scope_outcome_observations" ADD CONSTRAINT "project_scope_outcome_observations_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE cascade;--> statement-breakpoint
ALTER TABLE "project_scope_outcome_observations" ADD CONSTRAINT "project_scope_outcome_observations_baseline_id_project_scope_baseline_versions_id_fk" FOREIGN KEY ("baseline_id") REFERENCES "public"."project_scope_baseline_versions"("id") ON DELETE cascade;--> statement-breakpoint
...
CREATE UNIQUE INDEX "project_scope_outcomes_baseline_key_unique" ON "project_scope_outcomes" USING btree ("baseline_id", "key");--> statement-breakpoint
...
CREATE INDEX "project_scope_outcome_observations_project_observed_idx" ON "project_scope_outcome_observations" USING btree ("project_id", "observed_at");
